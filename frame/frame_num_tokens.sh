...
for tokens in ${num_tokens[@]}; do
    echo "Running with $tokens tokens"
    ./frame_layer_1 4096 4096 2 2 ${tokens} $num_threads $coeffs_path $locs_path $inputs_path
done
